...
import VisitedCountriesItem from './components/VisitedCountriesItem'
        ...
        <ul className="countries-list-container">
          {countriesList.map(eachItem => (
            <CountriesList
              ...
              updatingVisitedCountries={this.updatingVisitedCountries}
            />
          ))}
        </ul>
        <h1 className="countries-heading">Visited Countries</h1>
        <div className="list-visited-countries">
          {newList.length > 0 ? (
              ...
              {countriesList.map(eachItem =>
                eachItem.isVisited ? (
                  <VisitedCountriesItem
                    key={eachItem.id}
                    countriesDetails={eachItem}
                    onDeletingVisitedCountries={this.onDeletingVisitedCountries}
                  />
                ) : (
                  ''
                ),
